...
const routes: Routes = [
  ...
  {
    path: 'add-etudiant',
    loadChildren: () => import('./pages/secure/home/add-etudiant/add-etudiant.module').then( m => m.AddEtudiantPageModule)
  },
  {
    path: 'add-note/:id',
    loadChildren: () => import('./pages/secure/affiche-note/add-note/add-note.module').then( m => m.AddNotePageModule)
  },
